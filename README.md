Python Programming MOOC 2026 - Exam intro Repository
This repository documents my personal solutions for Part I of the [University of Helsinki's free massive open online course (MOOC) on Python Programming](https://programming-26.mooc.fi/exam-intro#exam-questions-and-starting-the-exam) 


We'll look at the following chapter:

click [Introduction to Programming exam 18.07.](https://programming-25.mooc.fi/all-exercises)
...
1. Getting started
    <ol style="list-style-type: lower-roman; padding-left: 20px;">
        <li>Programming exercise: Type in a string</li>                                             
    </ol>
